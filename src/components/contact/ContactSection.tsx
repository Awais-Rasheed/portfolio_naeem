      ...
      <div className="grid grid-cols-1 gap-8 px-8 py-8 sm:grid-cols-2 lg:grid-cols-4">
        {contactInfoItems.map((item) => (
          ...
          >
            ...
            <p className="mt-3 font-sans text-[20px] font-semibold text-white">
              {item.label}
            </p>
            <p className="mt-1 font-sans text-[18px] leading-snug text-white/60">
              {item.value}
            </p>
          </div>
        ))}
...
export default function ContactUsSection() {
  return (
    <section className="relative w-full overflow-hidden bg-[#00081F] bg-blue-gradient px-6 py-16 sm:px-12 lg:px-16">
